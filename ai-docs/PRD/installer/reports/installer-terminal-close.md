...
- **QCG-2 now passes.** The replacement Reach candidate at source `75fa8d21a76909ce3ebdadfa45df31e3feef6adb` (SHA-256 `47edd32a93366bfac2d650c261869599e8f8730fc5aab5d9ddfaf918d63a21b5`), real utility archives and gate-produced four-unit skills passed the complete local staged-consumer verifier on gpt1: 157 assertions, no failures. [The replacement staged close](installer-real-staged-close-75fa8d21a.md) records the exact artifacts, 30 mapped files/stamps, declaration/gate parity, numeric/program/capability rules, shared/custom roots, absolute installed commands, both utility doctor/repair checks and whole-tree negative snapshots. The canonical proof tool updated this row. Historical missing-input and negative-only reports describe earlier states.
...
The current delivery lint rejects only QCG-9; see [current gate output](installer-delivery-gate-75fa8d21a.log). The done command is attempted again with this truthful blocked report; its refusal is retained in installer-done-gate-75fa8d21a.log. The project is not marked done. This is the fixture-reachable execution result requested in the dispatch, not final acceptance or publication.
