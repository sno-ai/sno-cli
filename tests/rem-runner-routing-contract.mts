...
const planPath = `${repoRoot}/openspec/changes/archive/2026-08-10-rem-job-state-contract/evidence/80-rem-job-state-contract/test-plan-section-5.md`;
const receiptPath = `${repoRoot}/openspec/changes/archive/2026-08-10-rem-job-state-contract/evidence/80-rem-job-state-contract/test-plan-section-5.sha256`;
